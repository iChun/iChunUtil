...
public class EventHandlerClientForge extends EventHandlerClient
{
    ...
    {
        MinecraftForge.EVENT_BUS.addListener(EventPriority.NORMAL, false, ClientPlayerNetworkEvent.LoggedInEvent.class, event -> eventListener.trigger(Minecraft.getInstance()));
    }

    @Override
    protected void registerAsOnClientDisconnectListener(EventListener<Minecraft> eventListener)
    {
        MinecraftForge.EVENT_BUS.addListener(EventPriority.NORMAL, false, ClientPlayerNetworkEvent.LoggedOutEvent.class, event -> eventListener.trigger(Minecraft.getInstance()));
    }
