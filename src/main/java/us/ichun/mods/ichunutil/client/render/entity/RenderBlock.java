package us.ichun.mods.ichunutil.client.render.entity;
...
public class RenderBlock extends Render
{
    ...
    {
        EntityBlock entBlock = (EntityBlock)entity;
        if(!entBlock.setup)
        {
            return;
        }
        ...
        if(entBlock.getCanRotate())
        {
            ...
            GlStateManager.rotate(EntityHelperBase.interpolateRotation(entBlock.prevRotYaw, entBlock.rotYaw, partialTicks), 0F, 1F, 0F);
            GlStateManager.rotate(EntityHelperBase.interpolateRotation(entBlock.prevRotPitch, entBlock.rotPitch, partialTicks), 0F, 0F, 1F);
