package me.ichun.mods.ichunutil.common.module.tabula.common.project.components;
...
public class Animation
{
    ...
    {
        ArrayList<AnimationComponent> set = sets.computeIfAbsent(cubeIdent, k -> new ArrayList<AnimationComponent>());
