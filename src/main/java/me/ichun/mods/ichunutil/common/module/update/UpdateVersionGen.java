...
public class UpdateVersionGen
{
    public static void generate()
    {
        ...
        versions = new TreeMap<>(Ordering.natural());
        map.put("GeneralLaymansAestheticSpyingScreen", versions);
        versions.put("1.12.2", "7.0.0");
        ...
        versions.put("1.12.2", iChunUtil.VERSION);
        versions.put("1.10.2", "6.5.0");
        ...
        versions = new TreeMap<>(Ordering.natural());
        map.put("MightyEnderChicken", versions);
        versions.put("1.12.2", "7.3.0");
