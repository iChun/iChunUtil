...
public abstract class AbstractPacket //Yes I know we could be an interface.
{
    ...
    public abstract void process(NetworkEvent.Context context); //done on networking thread. context.enqueueWork for main thread
    public final String readString(PacketBuffer buf) { return buf.readString(32767); }
}
