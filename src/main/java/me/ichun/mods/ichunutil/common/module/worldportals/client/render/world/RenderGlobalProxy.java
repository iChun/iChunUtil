        ...
        else
        {
            ...
            for(RenderGlobal.ContainerLocalRenderInformation renderglobal$containerlocalrenderinformation : this.renderInfos)
            {
                ...
                if(!classinheritancemultimap.isEmpty())
                {
                    ...
                    {
                        if(portal != null && pair != null && !(entity2 == mc.player && mc.gameSettings.thirdPersonView == 0) && portal.lastScanEntities.contains(entity2) && portal.getPortalInsides(entity2).intersectsWith(entity2.getEntityBoundingBox()))
                        {
