package me.ichun.mods.ichunutil.common.module.tabula.legacy.importer;
...
@Deprecated
public class ImportTabulaLegacy
{
    public static ProjectInfo createProjectInfo(File file)
    {
        try
        {
    ...
    private static int exploreTC2Info(ArrayList<ProjectInfo.CubeInfo> cubes, ArrayList<ProjectInfo.CubeGroup> groups, TC2Info.Group geometry, double posX, double posY, double posZ, double rotX, double rotY, double rotZ, float scaleX, float scaleY, float scaleZ, boolean isDegrees)
    {
        int cubeCount = 0;
        if(geometry.Shape != null)
        {
            ...
            {
                ProjectInfo.CubeInfo info = new ProjectInfo.CubeInfo(shape.Name == null ? "shape" + Integer.toString(cubeCount + 1) : shape.Name);
        ...
        if(geometry.Null != null)
        {
            ...
            {
                ProjectInfo.CubeGroup group = new ProjectInfo.CubeGroup(nul.Name);
                groups.add(group);
