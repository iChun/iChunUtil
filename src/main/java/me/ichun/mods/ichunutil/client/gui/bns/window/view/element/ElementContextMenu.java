...
public class ElementContextMenu<M extends Fragment<?>> extends ElementClickable<M>
        implements WindowContextMenu.IContextMenu
{
    ...
    public ElementContextMenu(@Nonnull M parent, String text, @Nonnull List<Object> contextMenuObjects, @Nonnull BiConsumer<WindowContextMenu.IContextMenu, ElementList.Item<?>> contextMenuReceiver)
    {
        super(parent, e -> {});
        this.text = text;
