    ...
    public void playEvent(EntityPlayer player, int type, BlockPos blockPosIn, int data) //Remove every case that plays sound instead
    {
        ...
        switch(type)
        {
            ...
            case 2007:
                ...
                float f = (float)(data >> 16 & 255) / 255.0F;
                float f1 = (float)(data >> 8 & 255) / 255.0F;
                float f2 = (float)(data >> 0 & 255) / 255.0F;
                ...
                for(int i2 = 0; i2 < 100; ++i2)
                {
                    ...
                    Particle particle1 = this.spawnParticle0(enumparticletypes.getParticleID(), enumparticletypes.getShouldIgnoreRange(), d6 + d22 * 0.1D, d7 + 0.3D, d9 + d26 * 0.1D, d22, d24, d26, new int[0]);
            ...
            case 2006:
                ...
                for(int l = 0; l < 200; ++l)
                {
                    ...
                    Particle particle = this.spawnParticle0(EnumParticleTypes.DRAGON_BREATH.getParticleID(), false, (double)blockPosIn.getX() + d3 * 0.1D, (double)blockPosIn.getY() + 0.3D, (double)blockPosIn.getZ() + d5 * 0.1D, d3, d4, d5, new int[0]);
