...
public class ModelBaseDummy extends ModelBase
{
    ...
    public void renderSelectedCube(CubeInfo info, ArrayList<CubeInfo> hidden, float f5, float zoomLevel, boolean hasTexture, boolean focus, boolean renderRotationPoint, boolean renderControls)
    {
        ...
        if(focus)
        {
            ...
            GlStateManager.glVertex3f(-border - (float)info.mcScale * f5, - (float)info.mcScale * f5, - (float)info.mcScale * f5);
            GlStateManager.glVertex3f((float)(info.dimensions[0] + info.mcScale) * f5 + border, - (float)info.mcScale * f5, - (float)info.mcScale * f5);

            GlStateManager.glVertex3f(-border - (float)info.mcScale * f5, (float)(info.dimensions[1] + info.mcScale) * f5, - (float)info.mcScale * f5);
            GlStateManager.glVertex3f((float)(info.dimensions[0] + info.mcScale) * f5 + border, (float)(info.dimensions[1] + info.mcScale) * f5, - (float)info.mcScale * f5);

            GlStateManager.glVertex3f(-border - (float)info.mcScale * f5, - (float)info.mcScale * f5, (float)(info.dimensions[2] + info.mcScale) * f5);
            GlStateManager.glVertex3f((float)(info.dimensions[0] + info.mcScale) * f5 + border, - (float)info.mcScale * f5, (float)(info.dimensions[2] + info.mcScale) * f5);

            GlStateManager.glVertex3f(-border - (float)info.mcScale * f5, (float)(info.dimensions[1] + info.mcScale) * f5, (float)(info.dimensions[2] + info.mcScale) * f5);
            GlStateManager.glVertex3f((float)(info.dimensions[0] + info.mcScale) * f5 + border, (float)(info.dimensions[1] + info.mcScale) * f5, (float)(info.dimensions[2] + info.mcScale) * f5);

            GlStateManager.glVertex3f(- (float)info.mcScale * f5, - (float)info.mcScale * f5, -border - (float)info.mcScale * f5);
            GlStateManager.glVertex3f(- (float)info.mcScale * f5, - (float)info.mcScale * f5, (float)(info.dimensions[2] + info.mcScale) * f5 + border);

            GlStateManager.glVertex3f(- (float)info.mcScale * f5, (float)(info.dimensions[1] + info.mcScale) * f5, -border - (float)info.mcScale * f5);
            GlStateManager.glVertex3f(- (float)info.mcScale * f5, (float)(info.dimensions[1] + info.mcScale) * f5, (float)(info.dimensions[2] + info.mcScale) * f5 + border);

            GlStateManager.glVertex3f((float)(info.dimensions[0] + info.mcScale) * f5, - (float)info.mcScale * f5, -border - (float)info.mcScale * f5);
            GlStateManager.glVertex3f((float)(info.dimensions[0] + info.mcScale) * f5, - (float)info.mcScale * f5, (float)(info.dimensions[2] + info.mcScale) * f5 + border);

            GlStateManager.glVertex3f((float)(info.dimensions[0] + info.mcScale) * f5, (float)(info.dimensions[1] + info.mcScale) * f5, -border - (float)info.mcScale * f5);
            GlStateManager.glVertex3f((float)(info.dimensions[0] + info.mcScale) * f5, (float)(info.dimensions[1] + info.mcScale) * f5, (float)(info.dimensions[2] + info.mcScale) * f5 + border);

            GlStateManager.glVertex3f(- (float)info.mcScale * f5, -border - (float)info.mcScale * f5, - (float)info.mcScale * f5);
            GlStateManager.glVertex3f(- (float)info.mcScale * f5, (float)(info.dimensions[1] + info.mcScale) * f5 + border, - (float)info.mcScale * f5);

            GlStateManager.glVertex3f((float)(info.dimensions[0] + info.mcScale) * f5, -border - (float)info.mcScale * f5, - (float)info.mcScale * f5);
            GlStateManager.glVertex3f((float)(info.dimensions[0] + info.mcScale) * f5, (float)(info.dimensions[1] + info.mcScale) * f5 + border, - (float)info.mcScale * f5);

            GlStateManager.glVertex3f(- (float)info.mcScale * f5, -border - (float)info.mcScale * f5, (float)(info.dimensions[2] + info.mcScale) * f5 );
            GlStateManager.glVertex3f(- (float)info.mcScale * f5, (float)(info.dimensions[1] + info.mcScale) * f5 + border, (float)(info.dimensions[2] + info.mcScale) * f5 );

            GlStateManager.glVertex3f((float)(info.dimensions[0] + info.mcScale) * f5, -border - (float)info.mcScale * f5, (float)(info.dimensions[2] + info.mcScale) * f5 );
            GlStateManager.glVertex3f((float)(info.dimensions[0] + info.mcScale) * f5, (float)(info.dimensions[1] + info.mcScale) * f5 + border, (float)(info.dimensions[2] + info.mcScale) * f5 );
