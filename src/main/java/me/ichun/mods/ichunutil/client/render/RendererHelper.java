...
//    }
    ...
    public static void drawColourOnScreen(int r, int g, int b, int alpha, double posX, double posY, double width, double height, double zLevel)
    {
        ...
        worldrenderer.pos(posX, posY + height, zLevel).color(r, g, b, alpha).endVertex();
        worldrenderer.pos(posX + width, posY + height, zLevel).color(r, g, b, alpha).endVertex();
        worldrenderer.pos(posX + width, posY, zLevel).color(r, g, b, alpha).endVertex();
        worldrenderer.pos(posX, posY, zLevel).color(r, g, b, alpha).endVertex();
        tessellator.draw();
        GlStateManager.enableTexture2D();
    }
