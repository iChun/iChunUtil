...
public abstract class ElementButtonAbstract<T extends ElementButtonAbstract<T>> extends ElementClickable<T>
{
    public @NotNull String text;
    public boolean renderBackground = true;

    public ElementButtonAbstract(@NotNull Fragment<?> parent, String s, TriConsumer<T, Double, Double> callback, @Nullable TriConsumer<T, Double, Double> rightMouseCallback)
    {
        super(parent, callback, rightMouseCallback);
        text = I18n.get(s);
    }

    public ElementButtonAbstract(@NotNull Fragment<?> parent, String s, TriConsumer<T, Double, Double> callback)
    {
        this(parent, s, callback, null);
    }

    public ElementButtonAbstract<T> disableBackground()
    {
