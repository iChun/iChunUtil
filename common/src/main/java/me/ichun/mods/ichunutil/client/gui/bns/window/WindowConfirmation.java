...
public class WindowConfirmation extends Window<Workspace, WindowConfirmation.ViewConfirmation>
{
    ...
    {
        public ViewConfirmation(@NotNull WindowConfirmation parent, String title, String text1, Consumer<Workspace> callbackOk, Consumer<Workspace> callbackCancel, boolean isYesNo)
        {
            super(parent, title);
