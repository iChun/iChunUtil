...
public class WindowValues extends Window<WorkspaceConfigs, WindowValues.ViewValues>
{
    public WindowValues(WorkspaceConfigs parent, TreeSet<ConfigBase> configs)
    {
        super(parent);
        setView(new ViewValues(this, configs.getFirst().getConfigName(), configs));
        pos(20, 20);
        size(200, 300);
        disableUndocking();
        disableDrag();
    ...
    public static class ViewValues extends View<ViewValues, WindowValues>
    {
        ...
        public ViewValues(@NotNull WindowValues parent, @NotNull String s, TreeSet<ConfigBase> configs)
        {
            super(parent, s);
            ...
            sv.setConstraint(new Constraint(sv).top(lastRotatable, Constraint.Property.Type.BOTTOM, 0)
            ...
            list.setConstraint(new Constraint(list).left(this, Constraint.Property.Type.LEFT, 0)
                .bottom(this, Constraint.Property.Type.BOTTOM, 0)
                .top(lastRotatable, Constraint.Property.Type.BOTTOM, 0)
        ...
        public void populateList()
        {
            ...
            if(config != null)
            {
                ...
                {
                    WindowPopup.popup(parent.parent, 0.6D, 140, null, I18n.get("gui.ichunutil.configs.noEditingServerConfig"));
                    return;
                }
        ...
        public void addControlFor(ConfigBase config, final ConfigBase.Category.Entry entry, ElementList.Item<?> item)
        {
            ...
            if(!handled)
            {
                ...
                {
                    ElementToggleTextable<?> toggle = new ElementToggleTextable<>(item, entryName, elementClickable -> {}).setToggled((boolean)o);
