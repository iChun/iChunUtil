...
public class Constraint
{
    ...
    public static Constraint matchParentRatio(@NotNull Constrainable c, @NotNull Rectangle parent, int i) // specifically for width/height ratio
    {
        return new Constraint(c)
        ...
        if(parent != null)
        {
            ...
            if(!(left.apply(this) | right.apply(this)))
            {
                if(hasTop() || hasBottom())
                {
                    ...
                    Rectangle attachment = hasTop() ? top.reference : bottom.reference;
            ...
            if(!(top.apply(this) | bottom.apply(this)))
            {
                if(hasLeft() || hasRight())
                {
                    ...
                    Rectangle attachment = hasLeft() ? left.reference : right.reference;
