...
public class ViewConfirmation<W extends Workspace, P extends Window<?,?>> extends View<P>
{
    //title will be localised, text won't.
    public ViewConfirmation(@NotNull P parent, String title, String text1, Consumer<W> callbackOk, Consumer<W> callbackCancel, boolean isYesNo)
    {
        super(parent, title);
        ...
        ElementButton<?> button = new ElementButton<>(this, I18n.get(isYesNo ? "gui.no" : "gui.cancel"), btn ->
        {
            ...
            {
                callbackCancel.accept((W)parent.parent);
            }
        });
        ...
        ElementButton<?> button1 = new ElementButton<>(this, I18n.get(isYesNo ? "gui.yes" : "gui.ok"), btn ->
        {
            ...
            if(callbackOk != null)
            {
                callbackOk.accept((W)parent.parent);
            }
        });
